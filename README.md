...
- ⚙️ **[Monist](https://github.com/ryanncode/monist)**: A high-performance Rust and WebGPU engine that compiles and executes experimental logic at hardware speed.
- 📐 **[NF-Sketches](https://github.com/ryanncode/nf-sketches)**: A Lean 4 formal lab that mathematically guarantees the structural boundaries for NF Set Theory.
